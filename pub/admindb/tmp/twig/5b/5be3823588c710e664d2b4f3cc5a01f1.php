...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/var/www/meetarts/public_html/pub/admindb/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
