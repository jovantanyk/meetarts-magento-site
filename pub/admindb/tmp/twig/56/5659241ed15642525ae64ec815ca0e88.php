...
class __TwigTemplate_52698d4c5784aa7b3366e9fb344998cc extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Switch to %svisual builder%s");
        ...
        // line 15
        echo $this->env->getFilter('notice')->getCallable()(twig_sprintf($___internal_parse_0_, (("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/database/designer", twig_array_merge(($context["url_params"] ?? null), ["query" => true]))) . "\">"), "</a>"));
        // line 18
        echo "
";
        // line 19
        if (($context["has_message_to_display"] ?? null)) {
            // line 20
            echo "  ";
            echo $this->env->getFilter('error')->getCallable()(_gettext("You have to choose at least one column to display!"));
            echo "
";
        }
        // line 22
...
";
    ...
    {
        return new Source("", "database/qbe/index.twig", "/var/www/meetarts/public_html/pub/admindb/templates/database/qbe/index.twig");
    }
}
