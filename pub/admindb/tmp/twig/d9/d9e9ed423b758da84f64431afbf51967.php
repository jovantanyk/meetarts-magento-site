...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/var/www/meetarts/public_html/pub/admindb/templates/database/structure/bulk_action_modal.twig");
    }
}
