...
namespace Atome\MagentoPayment\Vendor\Http\Message\StreamFactory;

use Atome\MagentoPayment\Vendor\Http\Message\StreamFactory;
use Atome\MagentoPayment\Vendor\Laminas\Diactoros\Stream as LaminasStream;
use Atome\MagentoPayment\Vendor\Psr\Http\Message\StreamInterface;
use Atome\MagentoPayment\Vendor\Zend\Diactoros\Stream as ZendStream;
