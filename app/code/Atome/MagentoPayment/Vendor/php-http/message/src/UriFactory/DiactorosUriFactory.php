...
namespace Atome\MagentoPayment\Vendor\Http\Message\UriFactory;

use Atome\MagentoPayment\Vendor\Http\Message\UriFactory;
use Atome\MagentoPayment\Vendor\Laminas\Diactoros\Uri as LaminasUri;
use Atome\MagentoPayment\Vendor\Psr\Http\Message\UriInterface;
use Atome\MagentoPayment\Vendor\Zend\Diactoros\Uri as ZendUri;
