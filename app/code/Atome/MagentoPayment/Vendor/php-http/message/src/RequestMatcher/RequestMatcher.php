...
namespace Atome\MagentoPayment\Vendor\Http\Message\RequestMatcher;

use Atome\MagentoPayment\Vendor\Http\Message\RequestMatcher as RequestMatcherInterface;
