...
namespace Atome\MagentoPayment\Vendor\Http\Message\Encoding;

use Atome\MagentoPayment\Vendor\Clue\StreamFilter as Filter;
use Atome\MagentoPayment\Vendor\Http\Message\Decorator\StreamDecorator;
