...
namespace Atome\MagentoPayment\Vendor\Http\Message\Formatter;

use Atome\MagentoPayment\Vendor\Http\Message\Formatter;
use Atome\MagentoPayment\Vendor\Psr\Http\Message\MessageInterface;
