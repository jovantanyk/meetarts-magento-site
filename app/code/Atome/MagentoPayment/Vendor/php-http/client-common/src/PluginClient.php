...
use Atome\MagentoPayment\Vendor\Http\Client\Exception as HttplugException;
use Atome\MagentoPayment\Vendor\Http\Client\HttpAsyncClient;
use Atome\MagentoPayment\Vendor\Http\Client\HttpClient;
use Atome\MagentoPayment\Vendor\Http\Client\Promise\HttpFulfilledPromise;
use Atome\MagentoPayment\Vendor\Http\Client\Promise\HttpRejectedPromise;
