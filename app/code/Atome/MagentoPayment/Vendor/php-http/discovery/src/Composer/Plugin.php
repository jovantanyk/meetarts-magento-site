...
namespace Atome\MagentoPayment\Vendor\Http\Discovery\Composer;

use Atome\MagentoPayment\Vendor\Composer\Composer;
use Atome\MagentoPayment\Vendor\Composer\DependencyResolver\Pool;
use Atome\MagentoPayment\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use Atome\MagentoPayment\Vendor\Composer\Factory;
use Atome\MagentoPayment\Vendor\Composer\Installer;
use Atome\MagentoPayment\Vendor\Composer\IO\IOInterface;
use Atome\MagentoPayment\Vendor\Composer\Json\JsonFile;
use Atome\MagentoPayment\Vendor\Composer\Json\JsonManipulator;
use Atome\MagentoPayment\Vendor\Composer\Package\Locker;
use Atome\MagentoPayment\Vendor\Composer\Package\Version\VersionParser;
use Atome\MagentoPayment\Vendor\Composer\Package\Version\VersionSelector;
use Atome\MagentoPayment\Vendor\Composer\Plugin\PluginInterface;
use Atome\MagentoPayment\Vendor\Composer\Repository\InstalledRepositoryInterface;
use Atome\MagentoPayment\Vendor\Composer\Repository\RepositorySet;
use Atome\MagentoPayment\Vendor\Composer\Script\Event;
use Atome\MagentoPayment\Vendor\Composer\Script\ScriptEvents;
use Atome\MagentoPayment\Vendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['Atome\\MagentoPayment\\Vendor\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['Atome\\MagentoPayment\\Vendor\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\RequestFactoryInterface', 'Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\ResponseFactoryInterface', 'Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\StreamFactoryInterface', 'Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'Atome\\MagentoPayment\\Vendor\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\Atome\MagentoPayment\Vendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
