...
namespace Atome\MagentoPayment\Vendor\Http\Discovery;

use Atome\MagentoPayment\Vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use Atome\MagentoPayment\Vendor\Http\Discovery\Exception\DiscoveryFailedException;
use Atome\MagentoPayment\Vendor\Http\Discovery\Exception\NoCandidateFoundException;
use Atome\MagentoPayment\Vendor\Http\Discovery\Exception\StrategyUnavailableException;
use Atome\MagentoPayment\Vendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
