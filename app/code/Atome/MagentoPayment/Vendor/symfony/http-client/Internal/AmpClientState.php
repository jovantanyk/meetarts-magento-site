...
use Atome\MagentoPayment\Vendor\Amp\CancellationToken;
use Atome\MagentoPayment\Vendor\Amp\Deferred;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\Connection\ConnectionLimitingPool;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\Connection\DefaultConnectionFactory;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\InterceptedHttpClient;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\Interceptor\RetryRequests;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\PooledHttpClient;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\Request;
use Atome\MagentoPayment\Vendor\Amp\Http\Client\Response;
use Atome\MagentoPayment\Vendor\Amp\Http\Tunnel\Http1TunnelConnector;
use Atome\MagentoPayment\Vendor\Amp\Http\Tunnel\Https1TunnelConnector;
use Atome\MagentoPayment\Vendor\Amp\Promise;
use Atome\MagentoPayment\Vendor\Amp\Socket\Certificate;
use Atome\MagentoPayment\Vendor\Amp\Socket\ClientTlsContext;
use Atome\MagentoPayment\Vendor\Amp\Socket\ConnectContext;
use Atome\MagentoPayment\Vendor\Amp\Socket\Connector;
use Atome\MagentoPayment\Vendor\Amp\Socket\DnsConnector;
use Atome\MagentoPayment\Vendor\Amp\Socket\SocketAddress;
