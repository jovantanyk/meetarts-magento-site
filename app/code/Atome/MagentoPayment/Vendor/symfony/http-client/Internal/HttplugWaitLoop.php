...
use Atome\MagentoPayment\Vendor\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, float $maxDuration = null, float $idleTimeout = null) : int
    {
        ...
        $guzzleQueue = \Atome\MagentoPayment\Vendor\GuzzleHttp\Promise\Utils::queue();
