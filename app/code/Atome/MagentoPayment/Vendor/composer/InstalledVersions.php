 ...
 */
namespace Atome\MagentoPayment\Vendor\Composer;

use Atome\MagentoPayment\Vendor\Composer\Autoload\ClassLoader;
use Atome\MagentoPayment\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Atome\\MagentoPayment\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
