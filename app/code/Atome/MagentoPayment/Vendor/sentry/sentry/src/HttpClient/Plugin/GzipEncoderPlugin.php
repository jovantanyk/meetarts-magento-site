...
namespace Atome\MagentoPayment\Vendor\Sentry\HttpClient\Plugin;

use Atome\MagentoPayment\Vendor\Http\Client\Common\Plugin as PluginInterface;
use Atome\MagentoPayment\Vendor\Http\Promise\Promise as PromiseInterface;
