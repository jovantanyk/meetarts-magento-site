...
use Atome\MagentoPayment\Vendor\Sentry\Integration\ErrorListenerIntegration;
use Atome\MagentoPayment\Vendor\Sentry\Integration\IntegrationInterface;
use Atome\MagentoPayment\Vendor\Symfony\Component\OptionsResolver\Options as SymfonyOptions;
use Atome\MagentoPayment\Vendor\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
final class Options
{
    ...
    private function configureOptions(OptionsResolver $resolver) : void
    {
        $resolver->setDefaults(['integrations' => [], 'default_integrations' => \true, 'send_attempts' => 0, 'prefixes' => \array_filter(\explode(\PATH_SEPARATOR, \get_include_path() ?: '')), 'sample_rate' => 1, 'enable_tracing' => null, 'traces_sample_rate' => null, 'traces_sampler' => null, 'profiles_sample_rate' => null, 'attach_stacktrace' => \false, 'context_lines' => 5, 'enable_compression' => \true, 'environment' => $_SERVER['SENTRY_ENVIRONMENT'] ?? null, 'logger' => 'php', 'release' => $_SERVER['SENTRY_RELEASE'] ?? null, 'dsn' => $_SERVER['SENTRY_DSN'] ?? null, 'server_name' => \gethostname(), 'ignore_exceptions' => [], 'ignore_transactions' => [], 'before_send' => static function (Event $event) : Event {
            ...
            return $transaction;
        }, 'trace_propagation_targets' => [], 'tags' => [], 'error_types' => null, 'max_breadcrumbs' => self::DEFAULT_MAX_BREADCRUMBS, 'before_breadcrumb' => static function (Breadcrumb $breadcrumb) : Breadcrumb {
            return $breadcrumb;
