...
namespace Atome\MagentoPayment\Vendor\Sentry\HttpClient\Authentication;

use Atome\MagentoPayment\Vendor\Http\Message\Authentication as AuthenticationInterface;
use Atome\MagentoPayment\Vendor\Psr\Http\Message\RequestInterface;
use Atome\MagentoPayment\Vendor\Sentry\Client;
