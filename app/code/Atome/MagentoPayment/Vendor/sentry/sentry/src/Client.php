...
namespace Atome\MagentoPayment\Vendor\Sentry;
...
use Atome\MagentoPayment\Vendor\Sentry\Integration\IntegrationInterface;
use Atome\MagentoPayment\Vendor\Sentry\Integration\IntegrationRegistry;
use Atome\MagentoPayment\Vendor\Sentry\Serializer\RepresentationSerializer;
use Atome\MagentoPayment\Vendor\Sentry\Serializer\RepresentationSerializerInterface;
use Atome\MagentoPayment\Vendor\Sentry\Serializer\SerializerInterface;
use Atome\MagentoPayment\Vendor\Sentry\State\Scope;
use Atome\MagentoPayment\Vendor\Sentry\Transport\TransportInterface;
/**
...
final class Client implements ClientInterface
{
     ...
     */
    public const SDK_VERSION = '3.20.1';
    /**
    ...
    private function addThrowableToEvent(Event $event, \Throwable $exception, EventHint $hint) : void
    {
        ...
        $exceptions = [];
        do {
            $exceptions[] = new ExceptionDataBag($exception, $this->stacktraceBuilder->buildFromException($exception), $hint->mechanism ?? new ExceptionMechanism(ExceptionMechanism::TYPE_GENERIC, \true, ['code' => $exception->getCode()]));
