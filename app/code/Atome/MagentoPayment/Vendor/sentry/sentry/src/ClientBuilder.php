...
use Atome\MagentoPayment\Vendor\Sentry\HttpClient\HttpClientFactory;
...
use Atome\MagentoPayment\Vendor\Sentry\Transport\DefaultTransportFactory;
use Atome\MagentoPayment\Vendor\Sentry\Transport\TransportFactoryInterface;
...
final class ClientBuilder implements ClientBuilderInterface
{
    ...
    private function createDefaultTransportFactory() : DefaultTransportFactory
    {
        ...
        $httpClientFactory = new HttpClientFactory(null, null, $streamFactory, null, $this->sdkIdentifier, $this->sdkVersion);
