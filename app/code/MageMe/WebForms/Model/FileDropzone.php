...
class FileDropzone extends AbstractFileDropzone
{
     ...
     * @param UrlInterface|null $frontendUrl
     */
    public function __construct(
        ResultRepositoryInterface $resultRepository,
        UrlInterface              $url,
        File\Context              $context,
        UrlInterface              $frontendUrl = null
    )
    {
    ...
    {
        if ($adminhtml) {
            return $this->getUrlInstance()->getUrl('webforms/file/dropzoneDownload', ['hash' => $this->getLinkHash()]);
        }
        if ($this->frontendUrl) {
     ...
     * @return UrlInterface
     */
    public function getUrlInstance(): UrlInterface
    {
        return $this->url;
    }
