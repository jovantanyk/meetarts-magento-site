...
class DateHelper
{
     ...
     */
    protected const convertZendToStrftimeDate = [
     ...
     */
    protected const convertZendToStrftimeTime = [
        'a' => '%p',
        'hh' => '%I',
        'h' => '%I',
        'HH' => '%H',
    ...
    /**
     * Convert zend date and format it according to locale settings.
     *
     * @param string $value
     * @param string $format
     * @return string
     ...
     * @return string
     */
    public function convertZendToStrftime(string $value, bool $convertDate = true, bool $convertTime = true): string
    {
        if ($convertTime) {
            $value = $this->convert($value, self::convertZendToStrftimeTime);
        }
        if ($convertDate) {
            $value = $this->convert($value, self::convertZendToStrftimeDate);
        }
        return $value;
    }
