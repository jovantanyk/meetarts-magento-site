...
class Processor
{
    ...
    public function _initLog()
    {
        ...
        $activity->setModule($this->helper->getActivityModuleName(isset($this->eventConfig['module']) ? $this->eventConfig['module'] : ' '));
        $activity->setActionType(isset($this->eventConfig['action']) ? $this->eventConfig['action'] : ' ');
